...
class PAttUNet_EPED(nn.Module):
    def __init__(self, input_channels=3, num_classes = 1, deep_supervision=False):
        super(PAttUNet_EPED,self).__init__()
...
class DAttUNet_EPED(nn.Module):
    def __init__(self, input_channels=3, num_classes = 1, deep_supervision=False):
        super(DAttUNet_EPED, self).__init__()
